...
<head>
    ...
    <title>404 Not Found - {{ config('app.name', 'SMANSAGO') }}</title>
...
<body class="font-sans antialiased text-slate-800 dark:text-slate-100 bg-slate-50 dark:bg-slate-950 min-h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-lg w-full px-6 text-center">
        ...
        <h1 class="text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500 mb-4 tracking-tight">404</h1>
        <h2 class="text-2xl font-bold mb-4">Halaman Tidak Ditemukan</h2>
        <p class="text-slate-500 dark:text-slate-400 mb-8">Maaf, halaman yang Anda cari mungkin telah dihapus, namanya diubah, atau sementara tidak tersedia.</p>
