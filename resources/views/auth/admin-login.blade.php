    ...
    <div class="w-full max-w-[440px] relative z-10">
        ...
        <div class="bg-black/40 backdrop-blur-md rounded-3xl shadow-2xl shadow-black/50 border-2 overflow-hidden transition-all duration-500" style="border-color: rgba(214, 90, 32, 0.8);">
            ...
            <div class="flex flex-col items-center justify-center pt-8 pb-5 px-8">
                ...
                {{-- Title --}}
                <h1 class="text-xl text-white leading-tight flex items-center justify-center gap-2 mb-1">
                    ...
                    <span class="font-bold tracking-widest uppercase text-center">PORTAL LOGIN ADMIN</span>
                </h1>
            ...
            {{-- Form --}}
            <form method="POST" action="{{ route('admin.login.store') }}" class="px-8 pb-8 space-y-4">
                @csrf
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                            <i class="fas fa-user-shield text-white/50 text-sm group-focus-within:text-[#D65A20] transition-colors duration-200"></i>
                        </div>
                ...
                <div class="pt-3">
                    <button type="submit" id="login-btn"
                        ...
                        <span class="tracking-wider">LOGIN ADMIN</span>
                    </button>
                </div>
            </form>
